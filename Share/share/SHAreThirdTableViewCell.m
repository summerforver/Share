...
@implementation SHAreThirdTableViewCell
...
-  (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.labelFifth = [[UILabel alloc] init];
        [self.contentView addSubview:_labelFifth];
...
- (void)layoutSubviews {
    ...
    _labelSecond.frame = CGRectMake(180, 40, 90, 10);
    ...
    _labelSecond.font = [UIFont systemFontOfSize:17.0];
    
    _labelThird.frame = CGRectMake(280, 40, 100, 10);
    ...
    _labelFourth.frame = CGRectMake(180, 60, 180, 10);
    ...
    _labelFifth.frame = CGRectMake(180, 80, 100, 10);
    _labelFifth.backgroundColor = [UIColor whiteColor];
    _labelFifth.textColor = [UIColor colorWithRed:0.25f green:0.25f blue:0.25f alpha:1.00f];
    _labelFifth.font = [UIFont systemFontOfSize:12.0];
    ...
    _buttonSecond.frame = CGRectMake(237, 99, 50, 23);
